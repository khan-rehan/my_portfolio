...
import favicon from '@images/favicons2/favicon.ico';
...
import androidIcon192x192_2 from '@images/favicons2/android-chrome-192x192.png';
import androidIcon512x512_2 from '@images/favicons2/android-chrome-512x512.png';
import favicon32x32_2 from '@images/favicons2/favicon-32x32.png';
import favicon16x16_2 from '@images/favicons2/favicon-16x16.png';
import appleTouchIcon from '@images/favicons2/apple-touch-icon.png';
...
const Head = ({ metadata }) => (
  <Helmet>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href={androidIcon192x192_2} />
    <link rel="icon" type="image/png" sizes="192x192" href={appleTouchIcon} />
    <link rel="icon" type="image/png" sizes="512x512" href={androidIcon512x512_2} />
    <link rel="icon" type="image/png" sizes="32x32" href={favicon32x32_2} />
    <link rel="icon" type="image/png" sizes="16x16" href={favicon16x16_2} />
